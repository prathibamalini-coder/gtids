...
const financialInclusionImg = "/assets/services/financial-inclusion.jpg";
const dbtImg = "/assets/services/dbt.jpg";
const literacyImg = "/assets/services/literacy.jpg";
const creditImg = "/assets/services/credit.jpg";
const savingsImg = "/assets/services/savings.jpg";
const livelihoodImg = "/assets/services/livelihood.jpg";
const networkImg = "/assets/services/network.jpg";
const partnershipsImg = "/assets/services/partnerships.jpg";
