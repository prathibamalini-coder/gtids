...
const imgInclusion = "/assets/services/financial-inclusion.jpg";
const imgDbt = "/assets/services/dbt.jpg";
const imgLiteracy = "/assets/services/literacy.jpg";
const imgCredit = "/assets/services/credit.jpg";
const imgSavings = "/assets/services/savings.jpg";
const imgLivelihood = "/assets/services/livelihood.jpg";
const imgNetwork = "/assets/services/network.jpg";
const imgPartnerships = "/assets/services/partnerships.jpg";
import {
  ArrowRight,
  ChevronDown,
  Plane,
  ...
  return (
    <>
      ...
      <section id="map" className="gradient-soft py-12 md:py-16 border-b border-border scroll-mt-24">
        <div className="w-full md:container-prose">
          <div className="text-center max-w-2xl mx-auto mb-8 px-4 md:px-0">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {offerings.map((o, i) => (
              ...
              >
                ...
                {/* Content */}
                <div className="relative p-3 md:p-6 flex-1 flex flex-col">
                  <h3 className="font-display text-sm md:text-lg text-foreground leading-snug">
                    {o.title}
                  </h3>
                </div>
              </article>
      ...
      <section className="container-prose py-10 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <a
            ...
            className="group relative block overflow-hidden rounded-3xl p-6 md:p-8 text-white shadow-elevated transition-transform hover:-translate-y-1"
            style={{
              background:
          ...
          >
            <div className="relative h-full flex flex-col justify-between gap-6">
              <div className="flex items-start gap-4">
                <div className="grid h-12 w-12 place-items-center rounded-xl bg-white/15 ring-1 ring-white/25 backdrop-blur shrink-0">
                  <Plane className="h-5 w-5" />
                </div>
                <div>
                  <span className="inline-block rounded-full bg-white/15 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-white backdrop-blur ring-1 ring-white/20">
                    Sister Company
                  </span>
                  <h3 className="mt-2 font-display text-xl md:text-2xl">Super Bee Aeronautics</h3>
              ...
              <div className="mt-auto">
                <span className="inline-flex items-center gap-2 rounded-full bg-accent/90 px-4 py-2 text-[12px] font-semibold text-accent-foreground transition-transform group-hover:-translate-y-0.5">
          ...
          {/* Card 2: Skilling / CUTM */}
          <div
            className="group relative block overflow-hidden rounded-3xl p-6 md:p-8 text-white shadow-elevated"
            style={{
              background:
            ...
            <div className="relative h-full flex flex-col justify-between gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h3 className="mt-2 font-display text-xl md:text-2xl">Centurion University</h3>
                  <p className="mt-1.5 text-xs md:text-sm text-white/85">
                    Our living lab for skills, innovation, and sustainable development.
                  </p>
                </div>
              </div>
              <div className="mt-auto">
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-[12px] font-semibold text-white backdrop-blur ring-1 ring-white/30 transition-transform group-hover:-translate-y-0.5"
                >
