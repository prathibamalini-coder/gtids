...
export function IndiaImpactMap() {
  ...
  return (
    <div className="relative mx-auto w-full md:max-w-5xl">
      ...
      <div
        className="relative rounded-[2rem] p-0 sm:p-6 md:p-10"
        style={{
          background:
      ...
      >
        ...
        {/* Legend */}
        <div className="mt-4 flex flex-col gap-3 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between px-4 md:px-0">
