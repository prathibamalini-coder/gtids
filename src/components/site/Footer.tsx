  ...
  return (
    ...
    >
      ...
      <div className="relative container-prose pt-16 pb-10 grid gap-12 lg:grid-cols-12">
        ...
        <div className="grid grid-cols-2 gap-8 col-span-full lg:contents">
          {/* Explore */}
          <div className="lg:col-span-2">
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-white/70">
              <li><Link href="/about" className="inline-flex items-center gap-1 hover:text-accent transition-colors">About Us</Link></li>
              <li><Link href="/vision" className="hover:text-accent transition-colors">Vision &amp; Mission</Link></li>
              <li><Link href="/services" className="hover:text-accent transition-colors">Services</Link></li>
              <li><Link href="/drone" className="hover:text-accent transition-colors">Drone</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-white/70">
              <li><Link href="/organization/directors" className="hover:text-accent transition-colors">Directors</Link></li>
              <li><Link href="/organization/team" className="hover:text-accent transition-colors">Team</Link></li>
              <li><Link href="/organization/organogram" className="hover:text-accent transition-colors">Organogram</Link></li>
              <li><Link href="/impact/stories" className="hover:text-accent transition-colors">Success Stories</Link></li>
              <li><Link href="/impact/partners" className="hover:text-accent transition-colors">Partners</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/75">
            ...
            <li className="flex gap-3">
              ...
              <a href="tel:+919348865447" className="hover:text-accent transition-colors">+91 93488 65447</a>
            </li>
            <li className="flex gap-3">
